const GrayVerifiedIcon = () => {
  return (
    <svg viewBox="0 0 22 22" aria-label="Verified government account" role="img" style={{ width: '1rem', flexShrink: 0 }}>
      <g>
...
export default GrayVerifiedIcon